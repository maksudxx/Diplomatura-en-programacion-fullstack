...
function createData() {
  ...
  const productos = [
    ...
    {
      productos_id: uuidv4(),
      producto_nombre: "Hamburguesa Clasica",
      producto_descripcion: "Hamburguesa con medallon de carne de 150gr. Lechuga, Tomate, aderezos y pan brioche",
      producto_precio: 50,
      producto_stock: 25,
      categoria_id: categoria[2].categoria_id,
      caracteristica_id: caracteristica[2].caracteristica_id,
    },
    {
      productos_id: uuidv4(),
      producto_nombre: "Hamburguesa doble con cheddar y bacón",
      producto_descripcion: "Hamburguesa con 2 medallones de carne de 150gr. queso cheddar, bacón, aderezos y pan brioche",
      producto_precio: 80,
      producto_stock: 25,
      categoria_id: categoria[2].categoria_id,
      caracteristica_id: caracteristica[2].caracteristica_id,
    ...
    {
      productos_id: uuidv4(),
      producto_nombre: "Hamburguesa alemana",
      producto_descripcion: "Hamburguesa con medallon de carne de 150gr. salchicha alemana, queso dambo y pan brioche",
      producto_precio: 70,
      producto_stock: 25,
      categoria_id: categoria[2].categoria_id,
      caracteristica_id: caracteristica[2].caracteristica_id,
    ...
    {
      productos_id: uuidv4(),
      producto_nombre: "Hamburguesa picante",
      producto_descripcion: "Hamburguesa con medallon de carne de 150gr. tomate, cebolla, jalapeños, palta y pan brioche ",
      producto_precio: 70,
      producto_stock: 25,
      categoria_id: categoria[2].categoria_id,
      caracteristica_id: caracteristica[1].caracteristica_id,
    ...
    {
      productos_id: uuidv4(),
      producto_nombre: "Smash Burguer",
      producto_descripcion: "Hamburguesa con 2 medallones de carne de 150gr. queso cheddar, cebolla, tomate, aderezos y pan brioche ",
      producto_precio: 75,
      producto_stock: 25,
      categoria_id: categoria[2].categoria_id,
      caracteristica_id: caracteristica[2].caracteristica_id,
